...
CupcakeRootPath=/home/suroot/projects/cupcake/Cupcake

gameProjectFile=/home/suroot/projects/cupcake/Cupcake/Cupcake.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(CupcakeSource.pri)
include(CupcakeHeader.pri)
include(CupcakeConfig.pri)
include(CupcakeIncludes.pri)
include(CupcakeDefines.pri)
...
Cupcake-Linux-Debug.commands = $$build Cupcake Linux Debug  -project="\"$$gameProjectFile\"" $$args
Cupcake-Linux-DebugGame.commands = $$build Cupcake Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Cupcake-Linux-Shipping.commands = $$build Cupcake Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Cupcake-Linux-Test.commands = $$build Cupcake Linux Test  -project="\"$$gameProjectFile\"" $$args
Cupcake.commands = $$build Cupcake Linux Development  -project="\"$$gameProjectFile\"" $$args

CupcakeEditor-Linux-Debug.commands = $$build CupcakeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
CupcakeEditor-Linux-DebugGame.commands = $$build CupcakeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CupcakeEditor-Linux-Shipping.commands = $$build CupcakeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CupcakeEditor-Linux-Test.commands = $$build CupcakeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
CupcakeEditor.commands = $$build CupcakeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Cupcake-Linux-Debug \
	Cupcake-Linux-DebugGame \
	Cupcake-Linux-Shipping \
	Cupcake-Linux-Test \
	Cupcake \
	CupcakeEditor-Linux-Debug \
	CupcakeEditor-Linux-DebugGame \
	CupcakeEditor-Linux-Shipping \
	CupcakeEditor-Linux-Test \
	CupcakeEditor \
